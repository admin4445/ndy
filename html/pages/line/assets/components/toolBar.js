 var dxComponentLineToolBar ={
    ...
    +'<input  type="text" v-model="Contacts" name="username" lay-verify="required" placeholder="admin" autocomplete="off" class="layui-input" style="float:left;width:220px;">'
