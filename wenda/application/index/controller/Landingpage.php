        ...
        if ($this->GetAuth("Landingpage/selectLandingpage")) {
            ...
            if ($data) {
                for($i=0;$i<count($data);$i++){
					...
					$data[$i]["P"]="http://".$data[$i]["BindDomain"]."/wenda/".$data[$i]["Template"].'/'."Public/index.php/index/Show/p?id=".$data[$i]["Landingpage_Id"];
					$data[$i]["W"]="http://".$data[$i]["BindDomain"]."/wenda/".$data[$i]["Template"].'/'."Public/index.php/index/Show/w?id=".$data[$i]["Landingpage_Id"];
